        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="availableroom.php"><i class="fa fa-dashboard"></i>Rooms Status</a>
                    </li>
					<li>
                    ...
                    <div class="panel panel-primary">
						...
						<form name="form" method="post">
                            <div class="form-group">
                                            ...
                                            <input type="text" name="troom"  class="form-control" required>
												
                              </div>
							    <div class="form-group">
                                            <label>Rent Fee (Day)*</label>
                            ...
                            ;
										...
										$sql ="INSERT INTO room ( type, bedding, price, availstat) VALUES ('$room','$bed','$price','$stat')" ;
